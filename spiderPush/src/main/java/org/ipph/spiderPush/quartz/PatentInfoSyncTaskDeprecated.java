...
@EnableScheduling*/
@Deprecated
public class PatentInfoSyncTaskDeprecated {

	private Logger logger=LoggerFactory.getLogger(PatentInfoSyncTaskDeprecated.class);
	...
	public void syncPatent(){
	 ...
	 private void processPatentList(List<PatentInfo> patentList) {
		 ...
		 try {
			patentSyncApi.syncPatent("http://localhost:8001/patent/syncPatent",appNumbers);
		} catch (Exception e) {
		}
	 }
}
